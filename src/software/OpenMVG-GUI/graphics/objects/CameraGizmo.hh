 ...
 */
class CameraGizmo : public IntersectableObject, public RenderableObject, public WeightedSelectableObject
{
public:
  /**
   * @brief Ctr
   ...
   */
  CameraGizmo( std::shared_ptr<OpenGLContext> ctx, std::shared_ptr<ShaderProgram> shad,
               const openMVG::geometry::Pose3 &pose, const bool is_spherical = true, const double size = 1.0 );
