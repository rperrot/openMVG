 ...
 */
WorkerProjectCreation::WorkerProjectCreation( const std::string &base_path, const std::string &image_path,
    const IntrinsicParams &intrin, const std::string &database_file,
    std::shared_ptr<SceneManager> s_mgr, const WorkerNextAction &na )
  : WorkerInterface( na )
