...
*/
WorkerIncrementalSfMComputation::WorkerIncrementalSfMComputation( std::shared_ptr<Project> & proj ,
    ...
    const bool reload_initial_intrinsics ,
...
void WorkerIncrementalSfMComputation::process( void )
{
  ...
  openMVG::sfm::SequentialSfMReconstructionEngine sfmEngine(
    *sfm_data,
    incremental_path,
    stlplus::create_filespec( incremental_path, "Reconstruction_Report.html" ) );
  ...
  if ( sfmEngine.Process() )
  {
    ...
    openMVG::sfm::Generate_SfM_Report( sfmEngine.Get_SfM_Data(),
                                       stlplus::create_filespec( incremental_path , "SfMReconstruction_Report.html" ) );

    //-- Export to disk computed scene (data & visualizable results)
    std::cout << "...Export SfM_Data to disk." << std::endl;
    openMVG::sfm::Save( sfmEngine.Get_SfM_Data(),
                        stlplus::create_filespec( incremental_path , "sfm_data", ".bin" ),
                        openMVG::sfm::ESfM_Data( openMVG::sfm::ESfM_Data::ALL ) );

    openMVG::sfm::Save( sfmEngine.Get_SfM_Data(),
                        stlplus::create_filespec( incremental_path , "cloud_and_poses", ".ply" ),
                        openMVG::sfm::ESfM_Data( openMVG::sfm::ESfM_Data::ALL ) );
