...
class WorkerMatchesComputation : public QObject, public WorkerInterface
{
  public:
     ...
     */
    WorkerMatchesComputation( std::shared_ptr<Project> &proj, std::shared_ptr<openMVG::sfm::Regions_Provider> &regions_provider, const WorkerNextAction &na = NEXT_ACTION_NONE );
