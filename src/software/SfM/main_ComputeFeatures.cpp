...
#ifdef OPENMVG_USE_OPENCL
  #include "openMVG/features/sift/gpu/SIFT_Anatomy_Image_Describer_gpu_io.hpp"
#endif
...
#ifdef OPENMVG_USE_OPENCL
    else if( sImage_Describer_Method == "SIFT_ANATOMY_GPU" )
    {
      image_describer.reset(
        new gpu::SIFT_Anatomy_Image_describerGPU( gpu::SIFT_Anatomy_Image_describerGPU::Params() ) );
    }
#endif
